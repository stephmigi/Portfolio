...
namespace ObjectModel
{
    public static class FakeProfileSimulator
    {
        public static FakeProfile GetAFakeProfile()
        {
            ...
            var r1 = new IntechRealisation("TiDoi", 1, "TiDoi.png");
            ...
            r1.Semester = IntechSemester.S3;

            var r2 = new IntechRealisation("BlogOn", 2, "blogon.png");
            ...
            r2.Semester = IntechSemester.S2;

            var r3 = new IntechRealisation("MKS", 3, "LogoMKS.png");
            ...
            r3.Semester = IntechSemester.S5;

            var r4 = new IntechRealisation("Web Academy", 4, "webacademy.png");
